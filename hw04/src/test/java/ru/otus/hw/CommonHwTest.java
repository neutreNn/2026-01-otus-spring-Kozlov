...
class CommonHwTest {
    ...
    @Test
    void shouldContainConfigurationPropertiesAnnotationAboveAppPropertiesClass() {
        assertThat(AppProperties.class.isAnnotationPresent(ConfigurationProperties.class)).isTrue();
    }
